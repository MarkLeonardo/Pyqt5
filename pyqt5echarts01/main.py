...
class Form(QDialog):
    ...
    def load_url(self):
        url = QUrl("file:///home/cheyou/PycharmProjects/pyqt5echarts02/template.html")
        self.view.load(url)
    ...
    def create_pie(self, v):
        ...
        pie.add("鍟嗗", ATTR, v, is_label_show=True)
    ...
    def create_bar(self, v):
        ...
        bar.add('鍟嗗1', ATTR, v, is_more_utils=True)
        bar.add('鍟嗗2', ATTR, v, is_more_utils=True)
    ...
    def create_line(self, v):
        ...
        line.add("鍟嗗", ATTR, v, is_smooth=True, mark_line=["max", "average"])
    ...
    def create_line_bar(self, v):
        ...
        line.add("鍟嗗", ATTR, v, is_smooth=True, mark_line=["max", "average"])
        bar = Bar(TITLE_TEXT, TITLE_SUBTEXT)
        bar.add('鍟嗗', ATTR, v, is_more_utils=True)
